      ...
      <div
        className={cn(
          ...
          isUrgent
            ...
            : "bg-stone-50 dark:bg-slate-950 border-stone-200 dark:border-slate-800 border-b-stone-300 dark:border-b-slate-700 shadow-sm hover:shadow-md hover:-translate-y-0.5",
        )}
      >
          ...
          <div
            className={cn(
              ...
              isUrgent
                ...
                : "bg-white dark:bg-slate-900 border-stone-200 dark:border-slate-800 text-stone-400 dark:text-slate-500 dark:text-slate-400",
            )}
          >
            {isUrgent ? (
        ...
        <div className="flex items-center gap-3 mt-2 relative z-10">
          {timeLeft === null ? (
            <div className="h-10 w-48 bg-stone-200 dark:bg-slate-700 rounded-2xl animate-pulse" />
          ) : (
            <>
              {timeLeft.days > 0 && (
                <TimeSegment
    ...
    <div className="flex flex-col items-center min-w-[60px]">
      <span
        className={cn(
          ...
          urgent ? "text-rose-600" : "text-stone-700 dark:text-slate-200",
        )}
      >
