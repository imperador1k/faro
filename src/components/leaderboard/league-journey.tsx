...
const LEAGUES = [
  ...
  },
  {
    ...
    activeBg: "bg-slate-50 dark:bg-slate-950 border-slate-300",
...
export function LeagueJourney({ currentLeague }: Props) {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] border-2 border-stone-200 dark:border-slate-800 border-b-[10px] p-6 md:p-8 shadow-sm overflow-hidden relative">
      ...
      <p className="text-center text-[10px] font-black uppercase tracking-[0.2em] text-stone-400 dark:text-slate-500 dark:text-slate-400 mb-6 relative z-10">
        ...
        {LEAGUES.map((league, index) => {
          ...
          return (
            <div key={league.key} className="flex items-center flex-1">
              ...
              >
                <div
                  className={cn(
                    ...
                    isUnlocked
                      ? league.activeBg
                      : "bg-stone-100 dark:bg-slate-800 border-stone-200 dark:border-slate-800",
              ...
              {!isLast && (
                <div className="flex-1 h-1.5 mx-1 md:mx-2 rounded-full overflow-hidden bg-stone-100 dark:bg-slate-800">
                  <motion.div
                    className={cn(
                      "h-full rounded-full",
