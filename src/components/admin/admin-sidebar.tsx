...
export const AdminSidebar = () => {
  ...
  return (
    <aside className="w-[280px] bg-white dark:bg-slate-900 text-slate-500 dark:text-slate-400 flex-col hidden lg:flex border-r-[4px] border-stone-200 dark:border-slate-800 z-20 pb-4 shadow-sm">
      {/* Logo */}
      <Link href="/admin">
        <div className="flex items-center gap-x-3 pb-6 pl-6 pt-8 border-b-2 border-stone-100 dark:border-slate-800">
          <div className="bg-sky-100 dark:bg-sky-900/30 p-2 rounded-xl rounded-br-sm border-2 border-sky-200 dark:border-sky-800 shadow-sm relative">
            <Image
              src="/duo_crying.png"
              height={32}
              width={32}
      ...
      <nav className="flex-1 p-5 flex flex-col gap-y-2 mt-4">
        <div className="text-[11px] font-black text-stone-400 dark:text-slate-500 dark:text-slate-400 uppercase tracking-widest pl-2 mb-3">
          Comandos Globais
        </div>
      ...
      <div className="px-5 mt-auto">
        <Link
          href="/learn"
          className="flex items-center gap-x-3 rounded-[16px] px-4 py-3.5 transition-all font-black text-[13px] uppercase tracking-wider text-stone-500 dark:text-slate-400 hover:bg-rose-50 dark:hover:bg-rose-950 hover:text-rose-500 dark:hover:text-rose-400 border-2 border-transparent border-b-[4px] hover:translate-x-1 cursor-pointer"
        >
