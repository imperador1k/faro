...
export const CourseForm = ({ initialData }: Props) => {
  ...
  return (
    <form
      ...
      className="bg-white dark:bg-slate-900 rounded-3xl shadow-sm border-2 border-slate-100 overflow-hidden"
    >
      <div className="p-8 flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center gap-6">
            ...
            <div
              ...
              className="w-28 h-28 rounded-3xl border-4 border-dashed border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 flex items-center justify-center overflow-hidden cursor-pointer hover:border-sky-400 hover:bg-sky-50 transition-all group relative shrink-0"
            >
              {preview ? (
                <Image
                  src={preview}
        ...
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            required
            className="w-full px-5 py-4 bg-slate-100 dark:bg-slate-800 border-2 border-transparent rounded-2xl text-base font-bold text-slate-700 dark:text-slate-200 outline-none focus:border-sky-400 focus:bg-white dark:bg-slate-900 transition-all placeholder:text-slate-400"
          />
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            required
            maxLength={5}
            className="w-full max-w-[150px] px-5 py-4 bg-slate-100 dark:bg-slate-800 border-2 border-transparent rounded-2xl text-base font-black text-slate-700 dark:text-slate-200 uppercase outline-none focus:border-sky-400 focus:bg-white dark:bg-slate-900 transition-all placeholder:text-slate-400 placeholder:normal-case"
          />
        </div>
