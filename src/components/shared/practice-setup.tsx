  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] py-10 px-4 md:px-6 animate-in fade-in zoom-in-95 duration-500 w-full mb-20 relative">
      ...
      <div className="text-center mb-10 md:mb-16">
        ...
        <h1 className="text-4xl md:text-5xl font-black text-stone-700 dark:text-slate-200 tracking-tight mb-4">
          {getTitle()}
        </h1>
        <p className="text-stone-500 dark:text-slate-400 font-medium text-lg md:text-xl max-w-2xl mx-auto">
          {getDescription()}
        </p>
      </div>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-[2rem] border-2 border-stone-200 dark:border-slate-800 border-b-8 p-6 md:p-8 flex flex-col gap-4">
            ...
            <div className="relative">
              <select
                ...
                className="w-full rounded-2xl border-2 border-stone-200 dark:border-slate-800 bg-stone-50 dark:bg-slate-950 p-5 md:p-6 text-stone-700 dark:text-slate-200 font-bold text-xl md:text-2xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-400 transition-all outline-none cursor-pointer appearance-none hover:bg-stone-100 dark:hover:bg-slate-800 dark:bg-slate-800"
              >
          ...
          <div className="bg-white dark:bg-slate-900 rounded-[2rem] border-2 border-stone-200 dark:border-slate-800 border-b-8 p-6 md:p-8 flex flex-col gap-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 md:gap-5">
              {["A1", "A2", "B1", "B2", "C1", "C2"].map((l) => {
                ...
                const isEvaluated =
                  recommendedLevel?.isEvaluated && recommendedLevel.level === l;
                const isSuggested =
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      isSelected
                        ...
                        : "border-stone-200 dark:border-slate-800 bg-white dark:bg-slate-900 text-stone-400 dark:text-slate-500 dark:text-slate-400 border-b-6 md:border-b-8 hover:bg-stone-50 dark:bg-slate-950 hover:border-b-4 hover:translate-y-1",
                    )}
                  >
                    {l}
