              ...
              <span
                className={cn(
                  ...
                  isCollapsed ||
                    ...
                    ? "top-0 right-0 w-4 h-4 text-[8px]"
                    : "top-1 right-1 lg:relative lg:top-auto lg:right-auto lg:ml-auto px-1.5 lg:px-2 py-0.5",
                )}
              >
                {isCollapsed ||
                (typeof window !== "undefined" && window.innerWidth < 1024)
    ...
    >
        ...
        {isMoreOpen && (
          <div className="flex flex-col gap-y-2 mt-2 w-full lg:pl-4 lg:border-l-2 lg:border-slate-200 animate-in slide-in-from-top-2 duration-200">
            ...
            <SidebarItem
              ...
              isCollapsed={isCollapsed}
              iconSrc={
                <GraduationCap className="h-5 w-5 lg:w-6 lg:h-6 shrink-0" />
              }
            />
            <SidebarItem
              label="Amigos"
            ...
            {isAdmin && (
              <SidebarItem
                ...
                isCollapsed={isCollapsed}
                iconSrc={
                  <ShieldAlert className="h-5 w-5 lg:w-6 lg:h-6 text-rose-500 shrink-0" />
                }
              />
            )}
          </div>
      ...
      <div className="mt-auto hidden lg:flex flex-col pt-4 items-center justify-center text-stone-400 gap-2 mb-2 w-full transition-all duration-300">
        ...
        >
          ...
          {!isCollapsed && (
            <span className="text-xs font-black tracking-widest">CTRL+K</span>
          )}
        </div>
      </div>
    </aside>
