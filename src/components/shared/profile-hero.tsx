...
export const ProfileHero = ({
  ...
  return (
    <div className="relative w-full mb-10 pt-20 group">
      ...
      <div
        className={cn(
          "absolute top-0 left-0 right-0 h-40 rounded-[3rem] shadow-sm z-0 transition-all duration-700 bg-stone-100 dark:bg-slate-800 border-2 border-stone-200 dark:border-slate-800 overflow-hidden flex items-center justify-center",
          !bannerImageUrl &&
      ...
      >
        ...
        {isOwner && (
          <div className="absolute top-4 right-4 z-20">
            <label className="cursor-pointer relative overflow-hidden flex items-center justify-center w-10 h-10 rounded-full bg-white/90 hover:bg-white dark:bg-slate-900 text-stone-600 dark:text-slate-300 shadow-md transition-all duration-300 backdrop-blur-sm border-2 border-stone-200 dark:border-slate-800 hover:scale-105 active:scale-95">
              {uploading || isPending ? (
      ...
      <div className="relative z-10 w-full bg-white dark:bg-slate-900 rounded-[3rem] border-2 border-stone-200 dark:border-slate-800 border-b-8 p-8 pt-16 lg:pt-8 shadow-sm flex flex-col lg:flex-row items-center lg:items-center gap-6 lg:gap-10 mt-16 lg:mt-12 transition-all hover:shadow-md flex-wrap lg:flex-nowrap">
        ...
        <div className="absolute -top-20 flex left-1/2 max-lg:-translate-x-1/2 lg:left-12 lg:translate-x-0">
          <div className="relative flex h-32 w-32 lg:h-36 lg:w-36 shrink-0 items-center justify-center rounded-[2rem] lg:rounded-[2.5rem] bg-white dark:bg-slate-900 text-5xl lg:text-6xl shadow-2xl ring-4 lg:ring-8 ring-white overflow-hidden border-2 border-stone-100 border-b-8 shadow-stone-200/50 group-hover:scale-105 transition-all duration-500 cursor-pointer">
            {imageUrl ? (
              <Image
                src={imageUrl}
                alt={t("avatar_alt")}
        ...
        <div className="lg:ml-[170px] w-full lg:flex-1 flex flex-col items-center lg:items-start text-center lg:text-left mt-0 min-w-0 px-2 lg:px-0">
          <div className="flex flex-col gap-1 w-full">
            ...
            <p className="text-stone-400 dark:text-slate-500 dark:text-slate-400 font-bold text-lg tracking-tight truncate w-full">
