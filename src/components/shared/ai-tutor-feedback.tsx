...
export const AITutorFeedback = ({
  ...
  if (status === "loading") {
    return (
      <div
        className={cn(
          "flex flex-col items-center justify-center p-4 bg-purple-50 rounded-2xl border-2 border-purple-100",
          className,
        )}
      >
  ...
  return (
    <div
      className={cn(
        "relative overflow-hidden bg-white/80 border-2 border-pink-200/50 rounded-2xl p-4 shadow-sm flex-1 min-w-0",
        className,
      )}
    >
