  ...
  return (
    <div className="flex flex-col items-center justify-center p-8 text-center bg-white border-2 border-stone-200 border-b-8 rounded-[2.5rem] shadow-sm max-w-2xl mx-auto my-8 animate-in fade-in zoom-in duration-300">
      ...
      <Button
        size="lg"
        onClick={onAction}
        className="h-auto min-h-[4rem] py-3 px-6 sm:px-10 bg-[#58cc02] text-white text-lg sm:text-xl font-black rounded-2xl border-2 border-transparent border-b-8 border-b-[#46a302] hover:bg-[#61da02] active:border-b-0 active:translate-y-2 transition-all uppercase tracking-wider sm:tracking-widest flex items-center justify-center gap-3 shadow-md w-full sm:w-auto whitespace-normal"
      >
        {actionText}
      </Button>
    </div>
