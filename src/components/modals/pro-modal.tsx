            ...
            <div className="space-y-3 px-6 py-5">
              {getBenefits(t).map((benefit, index) => (
                <div
                  key={benefit.title}
                  className={cn(
                    "flex items-start gap-4 rounded-2xl border-2 border-stone-100 bg-stone-50/50 p-3.5 transition-all hover:border-stone-200 dark:border-slate-800 hover:bg-stone-50 dark:bg-slate-950",
                ...
                >
                  ...
                  <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border-2 border-emerald-200 border-b-4 bg-emerald-50">
                    <benefit.icon
                      className={cn("h-4.5 w-4.5", benefit.iconColor)}
                    />
                  </div>
                  <div className="flex flex-col">
                    <span className="text-sm md:text-base font-black tracking-tight text-stone-700 dark:text-slate-200">
                      {benefit.title}
                    </span>
                    <span className="mt-0.5 text-xs md:text-sm font-medium text-stone-500 dark:text-slate-400 leading-tight">
                      {benefit.description}
                    </span>
                  </div>
                </div>
