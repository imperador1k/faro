    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
          ...
          <div className="relative flex flex-col items-center justify-center mb-4">
            ...
            <div
              className={cn(
                ...
                variant === "gained"
                  ? "animate-bounce drop-shadow-[0_0_20px_rgba(249,115,22,0.6)]"
                  : "",
              )}
            >
              <Flame
                ...
                >
                  ...
                  <div
                    className={cn(
                      ...
                      isToday && variant === "gained"
                        ? "ring-4 ring-orange-200 dark:ring-orange-900 scale-110"
                        : "",
                    )}
                  >
                    {isActive && "✓"}
        ...
        <DialogFooter className="sm:justify-center p-6 bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm border-t-2 border-slate-100 dark:border-slate-800">
          <Button
            variant={variant === "gained" ? "default" : "secondary"}
            className={cn(
              "w-full h-14 text-lg font-bold tracking-wide uppercase rounded-2xl",
              variant === "gained"
                ? "bg-orange-500 hover:bg-orange-400 border-b-4 border-orange-600 text-white"
                : "",
            )}
