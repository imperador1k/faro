...
export const NotificationSettingsModal = ({
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-md bg-white dark:bg-slate-900 p-0 rounded-[2.5rem] border-2 border-stone-200 dark:border-slate-800 border-b-[12px] shadow-2xl overflow-hidden group [&>button:last-child]:hidden">
        {/* Custom Close Button */}
        <DialogClose className="absolute right-6 top-6 z-50 flex h-10 w-10 items-center justify-center rounded-xl bg-stone-100 dark:bg-slate-800 text-stone-400 dark:text-slate-500 dark:text-slate-400 border-2 border-stone-200 dark:border-slate-800 border-b-4 hover:bg-stone-200 dark:hover:bg-slate-700 dark:bg-slate-700 hover:text-stone-600 dark:text-slate-300 active:border-b-0 active:translate-y-1 transition-all focus:outline-none">
