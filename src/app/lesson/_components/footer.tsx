        ...
        {status === "correct" && (
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 animate-in slide-in-from-bottom-2">
            <div className="flex items-center gap-4 w-full sm:w-auto">
              <div className="shrink-0 w-16 h-16 bg-white dark:bg-slate-900 rounded-full flex items-center justify-center shadow-sm">
        ...
        {status === "wrong" && (
          <div className="flex flex-col md:flex-row items-center justify-between gap-3 animate-in slide-in-from-bottom-2 w-full">
            <div className="flex items-center gap-3 shrink-0 w-full md:w-auto">
              <div className="shrink-0 w-12 h-12 md:w-16 md:h-16 bg-white dark:bg-slate-900 rounded-full items-center justify-center shadow-sm hidden sm:flex">
