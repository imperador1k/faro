            ...
            <button
              ...
              className={cn(
                ...
                !isSelected &&
                  !isMatched &&
                  !isWrongFlash &&
                  "border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:bg-slate-950 hover:-translate-y-0.5 hover:shadow-sm active:translate-y-1 active:border-b-2",
                isSelected &&
                  !isWrongFlash &&
                  "border-sky-400 bg-sky-50 text-sky-700 scale-[1.02] shadow-md shadow-sky-100/50",
                isMatched &&
                  "border-green-400 bg-green-50 text-green-600 opacity-40 cursor-default scale-95 border-b-2 translate-y-1",
                isWrongFlash &&
