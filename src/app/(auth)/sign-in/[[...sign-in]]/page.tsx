    ...
    <div className="min-h-[100dvh] w-full flex items-center justify-center bg-[#f7f7f7] lg:bg-slate-50 p-4 sm:p-6 overflow-hidden relative">
      ...
      >
        <div className="flex flex-col lg:flex-row w-full min-h-[500px]">
          {/* Left Side */}
          <div
            className="hidden lg:flex lg:w-5/12 bg-[#58cc02] p-12 flex-col items-center justify-center text-white text-center relative overflow-hidden transition-colors duration-500"
            style={{
              backgroundColor:
                step === "mfa"
                  ? isEmailMfa
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <h2 className="text-4xl font-black tracking-tight leading-tight">
                    {step === "login" ? (
                      <>
                        Bom ver-te <br /> de novo!
                      </>
                    ) : isEmailMfa ? (
                      <>
                        Verifica o <br /> teu Email!
                      </>
                    ) : (
                      <>
                        Segurança <br /> Máxima!
                  ...
                  <p className="text-white/90 font-bold text-lg max-w-[240px] mx-auto leading-relaxed">
                    {step === "login"
                      ? "Pronto para mais uma lição rápida e divertida? 🚀"
                      : isEmailMfa
                        ? "Enviámos um código de acesso para a tua caixa de entrada. 📧"
                        : "Insere o código do teu autenticador para continuar. 🛡️"}
                  </p>
                </motion.div>
              </AnimatePresence>
            </div>
              ...
              <AnimatePresence mode="wait">
                {step === "login" ? (
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="pt-4 text-center space-y-6">
                        <Link
                          ...
                          className="text-sky-500 font-bold hover:text-sky-600 transition-colors text-sm"
                        >
                        ...
                        <p className="text-slate-500 font-bold text-sm">
                          ...
                          <Link
                            href="/onboarding"
                            className="text-sky-500 hover:text-sky-600 underline underline-offset-4 decoration-2"
                          >
                            Cria uma agora
                          </Link>
                        </p>
                  ...
                  >
                    <div className="text-center space-y-2">
                      <div
                        className={`w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4 ${isEmailMfa ? "bg-amber-100 text-amber-500" : "bg-sky-100 text-sky-500"}`}
                      >
                        {isEmailMfa ? (
                          <svg
                            className="w-8 h-8"
                    ...
                    <form onSubmit={handleMFASignIn} className="space-y-6">
                      ...
                      {error && (
                        <motion.p
                          initial={{ opacity: 0, y: -10 }}
                          animate={{ opacity: 1, y: 0 }}
                          className={`text-sm font-bold text-center p-3 rounded-xl border ${error.includes("enviado") ? "text-green-600 bg-green-50 border-green-100" : "text-rose-500 bg-rose-50 border-rose-100"}`}
                        >
                          {error}
                        </motion.p>
                      )}
                      ...
                      <div className="space-y-3">
                        ...
                        {isEmailMfa && (
                          <button
                            ...
                            className="w-full py-2 text-sky-500 font-bold hover:text-sky-600 transition-colors text-sm"
                          >
