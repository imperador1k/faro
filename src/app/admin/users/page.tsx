        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-slate-500 dark:text-slate-400 font-medium">
              ...
              registado{users.length !== 1 ? "s" : ""} na plataforma.
            </p>
          </div>
        </div>
      </div>
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <div className="w-9 h-9 rounded-full overflow-hidden bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-800 shrink-0 relative shadow-sm">
                          {user.imageUrl ? (
                            <Image
                              src={user.imageUrl}
                              alt={fullName}
                    ...
                    <td className="px-6 py-4">
                      {isAdmin ? (
                        ...
                        <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 rounded-lg text-[10px] font-black uppercase tracking-widest border border-slate-200 dark:border-slate-800">
          ...
          <div className="p-16 flex flex-col items-center justify-center text-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm mt-1">
                A plataforma ainda não tem utilizadores registados.
              </p>
            </div>
          </div>
        )}
