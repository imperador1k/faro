              ...
              className={`
                ...
                ${
                  isSelected
                    ...
                    : "border-gray-200 bg-white dark:bg-slate-900 shadow-[0_4px_0_#e5e5e5] hover:bg-gray-50 active:shadow-none active:translate-y-[2px]"
                }
              `}
            >
              ...
              <div className="text-center">
                <p
                  className={`font-black text-base sm:text-xl mb-1 ${isSelected ? "text-[#58cc02]" : "text-[#4b4b4b]"}`}
                >
                  {course.title}
                </p>
