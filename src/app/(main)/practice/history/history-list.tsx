    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-2 overflow-x-auto pb-2">
        <Button
          ...
          className={cn(
            filter === "all" && "bg-slate-700 text-white hover:bg-slate-800",
          )}
        >
          Todos
        </Button>
        <Button
          ...
          className={cn(
            filter === "writing" && "bg-sky-500 text-white hover:bg-sky-600",
          )}
        >
        ...
        <Button
          ...
          className={cn(
            filter === "speaking" && "bg-rose-500 text-white hover:bg-rose-600",
          )}
        >
          ...
          feedbackData.corrections.length > 0 && (
            <div className="flex flex-wrap gap-2 mt-2">
              {feedbackData.corrections
                .slice(0, 2)
                .map(
                  (c: { original: string; correction: string }, i: number) => (
                    <div
                      key={i}
                      className="text-xs bg-red-50 text-red-700 px-2 py-1 rounded border border-red-100 flex items-center gap-1"
                    >
                      <span className="line-through opacity-60 max-w-[100px] truncate block">
                        {c.original}
                      </span>
                      <span>→</span>
                      <span className="font-bold max-w-[100px] truncate block">
                        {c.correction}
                      </span>
                    </div>
                  ),
