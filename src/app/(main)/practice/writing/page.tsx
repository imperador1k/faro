        ...
        <div className="lg:col-span-8 flex flex-col gap-6 md:gap-8">
          ...
          <section className="bg-white dark:bg-slate-900 rounded-[2rem] border-2 border-stone-200 dark:border-slate-800 border-b-8 p-6 md:p-8 flex flex-col sm:flex-row items-start gap-4 md:gap-6 relative overflow-visible z-10 transition-all hover:-translate-y-1 hover:border-b-[10px] hover:mb-[-2px]">
            <div className="w-14 h-14 md:w-20 md:h-20 shrink-0 bg-sky-100 rounded-[1.5rem] border-b-4 border-sky-200 flex items-center justify-center shadow-inner">
              <Sparkles
                className="w-7 h-7 md:w-10 md:h-10 text-sky-500"
                strokeWidth={2.5}
              />
            </div>
            ...
            <Textarea
              ...
              className={cn(
                ...
                feedback
                  ...
                  : "border-stone-200 dark:border-slate-800 text-stone-700 dark:text-slate-200 focus-visible:border-indigo-400 focus-visible:bg-indigo-50/10",
              )}
              value={userResponse}
            ...
            {!feedback && !isAnalyzing && (
              <div className="absolute bottom-6 right-6 hidden md:flex items-center gap-2 px-4 py-2 bg-stone-100 dark:bg-slate-800 rounded-[1rem] border-2 border-stone-200 dark:border-slate-800 font-black text-stone-500 dark:text-slate-400 text-xs tracking-widest uppercase shadow-sm">
                <span
                  className={cn(
                    "text-lg",
                    userResponse.trim().length > 0 ? "text-indigo-500" : "",
                  )}
                >
                  {userResponse.trim()
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 gap-4">
                      {feedback.corrections.map((correction, idx) => (
                        <div
                          key={idx}
                          className="rounded-[1.5rem] bg-white dark:bg-slate-900 p-5 md:p-6 border-2 border-stone-200 dark:border-slate-800 hover:border-indigo-200 transition-colors shadow-sm"
                        >
                          <div className="flex flex-col md:flex-row gap-4 items-start md:items-center mb-3">
                            ...
                            <div className="hidden md:flex shrink-0 w-8 h-8 rounded-full bg-stone-100 dark:bg-slate-800 items-center justify-center font-bold text-stone-400 dark:text-slate-500 dark:text-slate-400">
                              →
                            </div>
