    ...
    <div className="max-w-4xl mx-auto w-full p-4 sm:p-8 pb-24 animate-in fade-in duration-500">
      ...
      <div className="space-y-4 max-w-3xl mx-auto">
        {[1, 2, 3].map((i) => (
          <div
            key={i}
            className="bg-white dark:bg-slate-900 border-2 border-stone-200 dark:border-slate-800 border-b-8 rounded-3xl p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 relative overflow-hidden shadow-sm"
          >
            <div className="flex items-center gap-5 w-full">
              <div className="w-14 h-14 rounded-2xl bg-stone-200 dark:bg-slate-700 shrink-0 border-2 border-white shadow-sm ring-1 ring-stone-100 animate-pulse" />
              <div className="flex-1 space-y-2">
                <div className="h-5 w-3/4 bg-stone-200 dark:bg-slate-700 rounded-lg animate-pulse" />
                <div className="h-4 w-1/3 bg-stone-100 dark:bg-slate-800 rounded-md animate-pulse" />
              </div>
            </div>
            <div className="shrink-0 w-full h-12 sm:w-[160px] bg-stone-100 dark:bg-slate-800 border-2 border-stone-200 dark:border-slate-800 border-b-4 rounded-xl animate-pulse" />
          </div>
        ))}
      </div>
    </div>
