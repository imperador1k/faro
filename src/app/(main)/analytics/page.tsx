    ...
    <div className="flex flex-col gap-6 animate-in fade-in duration-500 w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {[1, 2, 3].map((i) => (
          <div
            key={i}
            className="bg-stone-100 dark:bg-slate-800 border-2 border-stone-200 dark:border-slate-800 border-b-8 rounded-2xl h-32 animate-pulse"
          />
        ))}
      </div>

      {/* Main Chart Skeleton */}
      <div className="bg-stone-100 dark:bg-slate-800 border-2 border-stone-200 dark:border-slate-800 border-b-8 rounded-3xl h-[400px] animate-pulse" />

      {/* Bottom Grid Skeleton */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-stone-100 dark:bg-slate-800 border-2 border-stone-200 dark:border-slate-800 border-b-8 rounded-2xl h-[300px] animate-pulse" />
        <div className="bg-stone-100 dark:bg-slate-800 border-2 border-stone-200 dark:border-slate-800 border-b-8 rounded-2xl h-[300px] animate-pulse" />
      </div>
    </div>
  );
