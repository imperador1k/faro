  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="font-bold text-green-700">{t("practice_title")}</p>
          <p className="text-xs text-green-500">{t("practice_description")}</p>
        </div>
      </div>
      <span className="text-green-400 text-xl group-hover:translate-x-1 transition-transform">
        →
      </span>
    </Link>
  );
